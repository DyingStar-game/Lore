...
- **Nom Officiel de la Lune :** (Le nom formel donné par les autorités).
    
- **Planète Hôte :** (Le nom de la planète autour de laquelle elle orbite).
...
- **Atmosphère & Respiration :** (Composition, pression. Préciser si une assistance respiratoire est nécessaire).
    
- **Température de Surface :** (La fourchette moyenne des températures ).
    
- **Climat Dominant :** (Les phénomènes météorologiques spécifiques à la surface lunaire ).
